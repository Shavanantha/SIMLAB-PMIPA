...
<head>
    ...
    <style>
        ...
        .btn-tambah { background: var(--primary); color: white; border: none; padding: 12px 25px; border-radius: 12px; font-weight: bold; transition: 0.3s; display: flex; align-items: center; gap: 10px; cursor: pointer; font-size: 0.9rem; flex-shrink: 0; }
        ...
        .btn-edit { color: #f39c12; text-decoration: none; margin-right: 15px; font-weight: bold; background: none; border: none; cursor: pointer; font-family: inherit; font-size: 0.9rem; padding: 0; }
        .btn-hapus { color: #e74c3c; text-decoration: none; font-weight: bold; font-size: 0.9rem; }

        /* --- MODAL ENGINE STYLE --- */
        .modal-overlay { display: none; position: fixed; top:0; left:0; width:100%; height:100%; background: rgba(0,0,0,0.5); z-index: 99999; justify-content: center; align-items: center; padding: 20px; box-sizing: border-box; }
        .modal-box { background: white; padding: 35px; border-radius: 25px; width: 100%; max-width: 500px; box-shadow: 0 15px 50px rgba(0,0,0,0.15); animation: slideDown 0.3s ease; box-sizing: border-box; max-height: 90vh; overflow-y: auto; }
        @keyframes slideDown { from { transform: translateY(-30px); opacity: 0; } to { transform: translateY(0); opacity: 1; } }
        
        .form-group { margin-bottom: 18px; }
        .form-group label { display: block; font-weight: bold; margin-bottom: 6px; color: #333; font-size: 0.85rem; }
        .form-group input, .form-group select, .form-group textarea { width: 100%; padding: 10px 15px; border: 1px solid #ddd; border-radius: 10px; box-sizing: border-box; outline: none; font-family: inherit; font-size: 14px; }
        ...
        /* 📱 JINAKKAN LAYOUT MANAJEMEN ALAT KHUSUS DI HP */
        @media screen and (max-width: 768px) {
            ...
            .sidebar div img { width: 45px !important; }
            .sidebar h2 { font-size: 1rem !important; margin-top: 5px !important; }

            .sidebar-nav-links { display: flex !important; flex-wrap: wrap; justify-content: center; gap: 8px; width: 100%; }
            .sidebar a { padding: 8px 12px !important; font-size: 12px !important; margin-bottom: 0 !important; flex: 1; min-width: 105px; justify-content: center; }
            .sidebar hr { display: none !important; }

            .content { margin-left: 0 !important; padding: 25px 15px !important; width: 100% !important; box-sizing: border-box; }
            .header-box { flex-direction: column; gap: 15px; text-align: center; margin-bottom: 25px; }
            .header-box h1 { font-size: 1.6rem !important; }
            .btn-tambah { width: 100%; justify-content: center; padding: 12px !important; }

            .table-responsive-wrapper { width: 100% !important; overflow-x: auto !important; -webkit-overflow-scrolling: touch; margin-top: 10px; }
            .table-card { padding: 20px 12px !important; border-radius: 20px !important; }
            table { min-width: 800px !important; }
            td, th { padding: 12px 8px !important; font-size: 0.85rem !important; }
            .img-preview { width: 45px; height: 45px; }
            .modal-box { padding: 25px 20px !important; border-radius: 20px !important; }
            .modal-box h3 { font-size: 1.15rem !important; }
        }
    </style>
</head>
<body>
